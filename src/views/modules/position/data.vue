  ...
  <div class="mod-data common">
    <div class="query-area">
      <ul>
        <li>
          <span>站点编号:</span>
          <el-input v-model="dataForm.stationCode" placeholder="站点编号" clearable style="width:200px"></el-input>
        </li>
        <li>
          <span>站点名称:</span>
          <el-input v-model="dataForm.stationName" placeholder="站点名称" clearable style="width:200px"></el-input>
        </li>
        <li>
          <span>计量点编号:</span>
          <el-input v-model="dataForm.positionCode" placeholder="计量点编号" clearable style="width:200px"></el-input>
        </li>
        <li>
          <span>计量点名称:</span>
          <el-input v-model="dataForm.positionName" placeholder="计量点名称" clearable style="width:200px"></el-input>
        </li>
        <li>
          <span>检测日期:</span>
      ...
      <ul>
        ...
        <li>
          <el-tooltip effect="dark" content="只能上传xls、xslx文件" placement="bottom">
            <button v-if="isAuth('position:positionimport:import')" type="button" class="bg-btn"
              @click="importFile">导入</button>
          </el-tooltip>
        </li>
        <li>
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" style="width: 100%;">
      ...
      <el-table-column prop="stationCode" header-align="center" align="center" label="站点编号"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="stationName" header-align="center" align="center" label="站点名称"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="positionCode" header-align="center" align="center" label="计量点编号"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="positionName" header-align="center" align="center" label="计量点名称"
        :show-overflow-tooltip="true"></el-table-column>
      ...
      <el-table-column prop="detectionElectricityC" header-align="center" align="center" width="80" label="电流C相"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="powerFactor" header-align="center" align="center" width="80" label="总功率因数"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="powerFactorA" header-align="center" align="center" width="80" label="功率因数A"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="powerFactorB" header-align="center" align="center" width="80" label="功率因数B"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="powerFactorC" header-align="center" align="center" width="80" label="功率因数C"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="activePower" header-align="center" align="center" width="80" label="有功功率"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="activePowerA" header-align="center" align="center" width="80" label="有功功率A"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="activePowerB" header-align="center" align="center" width="80" label="有功功率B"
        :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="activePowerC" header-align="center" align="center" width="80" label="有功功率C"
        :show-overflow-tooltip="true"></el-table-column>
    ...
    <el-dialog :visible.sync="importFileVisible" title="导入" width="770px">
      <div class="fileType">
        <span>选择导入:</span>
        <el-radio-group v-model="fileType">
          ...
          <el-radio :label="5">功率因数-项</el-radio>
          <el-radio :label="6">有功功率-项</el-radio>
          <el-radio :label="7" v-if="isAuth('electric:calculateimport:importcsv')">计量点检测数据</el-radio>
        </el-radio-group>
      </div>
      <div class="tips">
      ...
      <span slot="footer" class="importFile">
        ...
        <el-upload action="#" ref="fileupload_3"
          ...
          <button type="button" v-if="isAuth('position:positionimport:import')">确定</button>
        </el-upload>
      </span>
    </el-dialog>
  </div>
    ...
    methods: {
      ...
      getDataList() {
        if (this.detectionDayOptions.length) {
          ...
          this.$http({
            url: this.$http.adornUrl('/position/positionimport/listImport'),
            method: 'get',
            params: this.$http.adornParams({
              page: this.pageIndex,
              limit: this.pageSize,
              stationCode: this.dataForm.stationCode, // 变电站编号
              stationName: this.dataForm.stationName, // 变电站名称
              positionName: this.dataForm.positionName, // 计量点名称 
              positionCode: this.dataForm.positionCode, // 计量点编号
      ...
      uploadFile(item) {
        ...
        this.$http({
            url: this.$http.adornUrl('/position/positionimport/import'),
            method: 'post',
      ...
      startAnalysis() {
        ...
        this.$http({
          url: this.$http.adornUrl('/position/positionimport/checkImportCount'),
          method: 'post'
        }).then(({
          data
        }) => {
      ...
      getDetectionDay() {
        return new Promise((resolve, reject) => {
          this.$http({
            url: this.$http.adornUrl('/position/positionimport/selectImportDay'),
            method: 'get',
          }).then(({data}) => {
            if (data && data.code === 0) {
      ...
      downloadTemplate() {
        this.$http({
          ...
          excelDownload(data, '计量点检测数据模板.zip')
        }).catch(() => {
