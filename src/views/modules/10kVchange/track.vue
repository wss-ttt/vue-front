<template>
  <div class="mod-track common">
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small"
            @click.stop="examine(scope.row.id, scope.row.electricUserCode)">
            审核</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 异常评估折线图 -->
    <el-dialog :title="errorLine.electricUserCode + ' 异常评估折线图'" 
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl('/electric/assessresult/tailList'),
          method: 'get',
      ...
      exportData() {
        exportDataToExcel('/electric/assessresult/tailExport', this.dataForm).then(() => {}).catch(err => {
