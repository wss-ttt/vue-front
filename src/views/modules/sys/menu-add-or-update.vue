  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item :label="dataForm.typeList[dataForm.type] + '名称'" prop="name">
        <el-input v-model="dataForm.name" :placeholder="dataForm.typeList[dataForm.type] + '名称'" maxlength="50"></el-input>
      </el-form-item>
      ...
      <el-form-item v-if="dataForm.type === 1" label="菜单URL" prop="url">
        <el-input v-model="dataForm.url" placeholder="菜单URL" maxlength="200"></el-input>
      </el-form-item>
      <el-form-item v-if="dataForm.type !== 0" label="授权标识" prop="perms">
        <el-input v-model="dataForm.perms" placeholder="多个用逗号分隔, 如: user:list,user:create" maxlength="500"></el-input>
      </el-form-item>
  ...
  export default {
    data () {
      ...
      return {
        ...
        visible: false,
        popoverVisible:false,   // 控制上级菜单的显示隐藏
        dataForm: {
          id: 0,
          type: 1,
          typeList: ['目录', '菜单', '按钮'],
        ...
        this.$http({
          ...
          if (!this.dataForm.id) {
            ...
            this.$http({
              ...
              this.dataForm.status = data.menu.status  // 菜单状态 0:显示  1:隐藏
              this.menuListTreeSetCurrentNode()
            })
          }
        })
          ...
          if (valid) {
            ...
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'status':this.dataForm.status    // 菜单状态
              })
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.$message({
