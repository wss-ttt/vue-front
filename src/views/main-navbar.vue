<template>
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: homePageName })">
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom">
            <span class="el-dropdown-link">
              <img src="~@/assets/img/profile_small.jpg" :alt="userName">{{ userName }}
            </span>
...
.site-navbar__brand-mini{
  width: 48px;
  height: 48px;
  background: url('../assets/img/state-grid-logo.png') no-repeat left center;
}
</style>
